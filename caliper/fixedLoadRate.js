...
const Logger = require('/hyperledger/caliper/workspace/node_modules/@hyperledger/caliper-core/lib/common/utils/caliper-utils').getLogger('fixedBacklog.js');
    ...
    */
    async applyRateControl() {
        ...
        if (this.stats.getTotalFinishedTx() === 0) {
            // print input diff
            console.log(`INPUTGEN ${this.sleepTime}`);
        ...
        // print input diff
        console.log(`INPUTGEN ${sleepTime}`);
